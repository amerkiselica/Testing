#Unos svih tacnih podataka u kreiranju novog admin profila
import time
...
prezime.send_keys("Kiselica")

email=driver.find_element_by_name("email")
email.send_keys("amer123@gmail.com")

brojtelefona=driver.find_element_by_name("phone")
brojtelefona.send_keys("062555666")
